...
import { Terminal, Brain, Atom, Calculator, Award, MessageSquare } from "lucide-react"
...
export default function Dashboard() {
  ...
  const [connectedAddress, setConnectedAddress] = useState("0x1234...5678")
          ...
          <div className="flex items-center gap-4">
            ...
            <Avatar className="h-8 w-8 border border-green-500">
              ...
              <AvatarFallback className="bg-green-900/30 text-green-500">
                {connectedAddress.substring(0, 2)}
              </AvatarFallback>
            </Avatar>
            <span className="text-sm hidden md:inline">{connectedAddress}</span>
          </div>
        </div>
      </header>
        ...
        <Tabs defaultValue="agents" className="w-full">
          ...
          <TabsContent value="agents" className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <AgentCard
                ...
                description="Ask questions about organic chemistry, biochemistry, and more"
                href="/agents/chemistry"
              />
            </div>
          </TabsContent>
          ...
          <TabsContent value="questions">
            ...
            <div className="space-y-4">
              {questions
                .filter((q) => !q.isOwn)
                .sort((a, b) => a.reward - b.reward) // Sort by reward in ascending order
                .map((question) => (
                  <QuestionCard
                    key={question.id}
                    id={question.id}
